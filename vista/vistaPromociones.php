  ...
  <head>
   ...
   function reg_est(id) {
       ...
       try{ 
              ...
              $.ajax({
              type: "POST",
              url: '../controles/controlEstPromo.php',
              data:{t :touch, n :nav, p :id},
              success: function (result) { 
           ...
           <div class="row">
                ...
                <div class="col-4">
                  <div id="img_qr" name="img_qr" >
                      <img class="img-fluid" id="qr" name="qr" src=""/>
                  </div>
                  <h6>Presenta este código QR en el local para validar la promo</h6>
                </div>
           </div>
           <div class="row">
             <div class="col-12"><br>
